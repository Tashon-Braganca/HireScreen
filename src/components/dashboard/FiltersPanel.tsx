...
export function FiltersPanel() {
    ...
    return (
        <div className="space-y-4 p-4 border-b border-border bg-panel/50">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-muted">Filters</h3>

            <Accordion type="multiple" defaultValue={["auth", "location", "yoe", "skills"]} className="w-full">
                {/* Authorization */}
